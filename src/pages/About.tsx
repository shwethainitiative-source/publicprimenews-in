...
const About = () => {
  ...
  const socialLinks = [
    { icon: Youtube, label: "YouTube", url: settings?.youtube_link || "#", color: "hover:text-red-600" },
    { icon: Facebook, label: "Facebook", url: settings?.facebook_link || "#", color: "hover:text-blue-600" },
    { icon: Instagram, label: "Instagram", url: settings?.instagram_link || "#", color: "hover:text-pink-500" },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-5 text-foreground/90 leading-relaxed text-base md:text-lg">
              <p>
                ಕರಾವಳಿಯ ಕಡಲ ತೀರದ ಸಾಂಸ್ಕೃತಿಕ ವೈಭಂವದಿಂದ, ಸಿಲಿಕಾನ್ ಸಿಟಿಯ ಆಧುನಿಕತೆಯವರೆಗೆ – ಸಮಸ್ತ ಕನ್ನಡಿಗರ ನಾಡಿಮಿಡಿತವೇ ನಿಮ್ಮ 'ಪಬ್ಲಿಕ್ ಪ್ರೈಮ್ ನ್ಯೂಸ್'.
              </p>
              <p>
            ...
            <div className="mt-10 space-y-2 text-foreground/90 text-base md:text-lg">
              ...
              <p><strong>ಪಬ್ಲಿಕ್ ಪ್ರೈಮ್ ನ್ಯೂಸ್ ದೂರವಾಣಿ:</strong> {settings?.contact_number || "—"}</p>
              <p><strong>ಇಮೇಲ್:</strong> {settings?.email || "—"}</p>
            </div>
